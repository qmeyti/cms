...
class Jdf
{
            ...
            if ($m === '') {
                ...
                if ($s === '') {
                    ...
                    if ($jm === '') {
                        ...
                        $jdate = explode('_', Jdf::jdate('Y_j', '', '', $timezone, 'en'));
                        if ($jd === '') {
                            list($gy, $gm, $gd) = Jdf::jalali_to_gregorian($jdate[0], $jm, $jdate[1]);
                            return mktime($h, $m, $s, $gm);
                        } else {
                            if ($jy === '') {
                                list($gy, $gm, $gd) = Jdf::jalali_to_gregorian($jdate[0], $jm, $jd);
    ...
    public static function jgetdate($timestamp = '', $none = '', $timezone = 'Asia/Tehran', $tn = 'en')
    {
        ...
        $jdate = explode('_', Jdf::jdate('F_G_i_j_l_n_s_w_Y_z', $ts, '', $timezone, $tn));
        return array(
