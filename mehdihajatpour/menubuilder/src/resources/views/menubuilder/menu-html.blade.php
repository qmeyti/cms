                                                ...
                                                <div class="box box-default">
                                                    ...
                                                    <div id="collapse1" class="panel-collapse collapse in">
                                                        <div class="box-body">
                                                            ...
                                                            <div class="form-group">
                                                                <a href="#" class="btn btn-primary ladda-button" onclick="addcustommenu()"><span class="spinner" id="spincustomu"></span>Add menu
                                                                    item</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="box box-default">
                                                    ...
                                                    <div class="menu-edit ">
                                                        <div class="box-header with-border">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <input name="menu-name" id="menu-name" type="text" class="form-control" title="Enter menu name"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @elseif(request()->has("menu"))
                                                                        <a onclick="getmenus()" name="save_menu" id="save_menu_header" class="btn btn-primary ladda-button"><span class="spinner"
                                                                                                                                                                                  id="spincustomu2"></span>Save
                                                                            menu</a>
                                                                    @else
                                                                        <a onclick="createnewmenu()" name="save_menu" id="save_menu_header" class="btn btn-primary ladda-button">Create menu</a>
                                                                    @endif
                                                                ...
                                                                <ul class="menu ui-sortable" id="menu-to-edit">
                                                                            ...
                                                                            <li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending"
                                                                                ...
                                                                                <dl class="menu-item-bar">
                                                                                    <dt class="menu-item-handle">
                                                                                        <span class="item-title"> <span class="menu-item-title"> <span
                                                                                                    ...
                                                                                                    style="color: transparent;">|{{$m->id}}|</span> </span> <span class="is-submenu"
                                                                                                                                                                  style="@if($m->depth==0)display: none;@endif">Subelement</span> </span>
                                                                                        <span class="item-controls"> <span class="item-type">Link</span> <span class="item-order hide-if-js"> <a
                                                                                                    ...
                                                                                                    class="item-move-down"><abbr title="Move Down">↓</abbr></a> </span> <a class="item-edit"
                                                                                                                                                                           id="edit-{{$m->id}}"
                                                                                                                                                                           title=" "
                                                                                ...
                                                                                <div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" id="idlabelmenu_{{$m->id}}" class="form-control edit-menu-item-title"
                                                                                               name="idlabelmenu_{{$m->id}}" value="{{$m->label}}">
                                                                                    </div>

                                                                                    <div class="form-group">
                                                                                        <label for="edit-menu-item-classes-{{$m->id}}"> Class CSS (optional)</label>
                                                                                        <input type="text" id="clases_menu_{{$m->id}}" class="form-control edit-menu-item-classes"
                                                                                               name="clases_menu_{{$m->id}}" value="{{$m->class}}">
                                                                                    </div>

                                                                                    <div class="form-group">
                                                                                        <label for="edit-menu-item-url-{{$m->id}}"> Url</label>
                                                                                        <input type="text" id="url_menu_{{$m->id}}" class="form-control edit-menu-item-url" id="url_menu_{{$m->id}}"
                                                                                               value="{{$m->link}}">
                                                                                    </div>
              													...
              													<label><a href="{{ $currentUrl }}" class="menus-move-up btn btn-link" style="display: none;">Move up</a> <a href="{{ $currentUrl }}" class="menus-move-down btn btn-link" title="Mover uno abajo" style="display: inline;">Move Down</a> <a href="{{ $currentUrl }}" class="menus-move-left btn btn-link" style="display: none;"></a> <a href="{{ $currentUrl }}" class="menus-move-right btn btn-link" style="display: none;"></a> <a href="{{ $currentUrl }}" class="menus-move-top" style="display: none;">Top</a> </label>
                                                                                    ...
                                                                                    <div class="menu-item-actions description-wide submitbox">
                                                                                        ...
                                                                                        <a class="item-delete submitdelete deletion btn btn-danger" id="delete-{{$m->id}}"
                                                                                           href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Delete</a>
                                                                                        <span class="meta-sep hide-if-no-js"> | </span>
                                                                                        <a class="item-cancel submitcancel hide-if-no-js button-secondary btn btn-default" id="cancel-{{$m->id}}"
                                                                                           href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Close</a>
                                                                                        <span class="meta-sep hide-if-no-js"> | </span>
                                                                                        <a onclick="updateitem({{$m->id}})" class="button button-primary updatemenu btn btn-primary"
                                            ...
                                            <div class="box-footer">
                                                @if(request()->get('menu') != '0' && request()->has('menu'))
                                                    <h4 class="pull-right"><span class="delete-action"> <a class="btn btn-danger" onclick="deletemenu()"
                                                                                                           href="javascript:void(9)">Delete menu</a> </span></h4>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
