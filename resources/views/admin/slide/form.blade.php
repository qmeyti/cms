...
<div class="form-group{{ $errors->has('text1') ? 'has-error' : ''}} mb-3">
    ...
    {!! Form::text('text1', null, ('required' == 'required') ? ['class' => 'form-control'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('text2') ? 'has-error' : ''}} mb-3">
    ...
    {!! Form::text('text2', null, ('required' == 'required') ? ['class' => 'form-control'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('url') ? 'has-error' : ''}} mb-3">
    ...
    {!! Form::text('url', null, ('required' == 'required') ? ['class' => 'form-control ltr'] : ['class' => 'form-control ltr']) !!}
