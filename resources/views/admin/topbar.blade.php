                    ...
                    <ul class="dropdown-menu dropdown-menu-end text-right" aria-labelledby="dropdownMenuButton" style="min-width: 11rem;">
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <i class="icon-mid bi bi-person ms-2"></i>
                                مدیریت پروفایل
                            </a>
                        </li>
                        <li><a class="dropdown-item" href="#"><i class="icon-mid bi bi-gear ms-2"></i></a></li>
                        <li><a class="dropdown-item" href="#"><i class="icon-mid bi bi-wallet ms-2"></i></a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li>
                            <button onclick="document.getElementById('LOGOUT_FORM').submit();" class="dropdown-item"><i class="icon-mid bi bi-box-arrow-left ms-2"></i>خروج کاربر</button>
