            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('transitionkey.index') }}" title="بازگشت">
                        ...
                        <div>
                            ...
                            {!! Form::open([
                                  'method' => 'DELETE',
                                  'url' => route('transitionkey.destroy',['transitionkey' => $transitionkey->id]),
                ...
                {!! Form::model($transitionkey, ['method' => 'PATCH','url' => route('transitionkey.update',['transitionkey' => $transitionkey->id]),'class' => 'form-horizontal','files' => true]) !!}

                @include ('admin.transitionkey.form', ['formMode' => 'edit'])
