            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('translationkey.index') }}" title="بازگشت">
                        ...
                        <div>
                            ...
                            {!! Form::open([
                                  'method' => 'DELETE',
                                  'url' => route('translationkey.destroy',['translationkey' => $translationkey->id]),
                ...
                {!! Form::model($translationkey, ['method' => 'PATCH','url' => route('translationkey.update',['translationkey' => $translationkey->id]),'class' => 'form-horizontal','files' => true]) !!}

                @include ('admin.translationkey.form', ['formMode' => 'edit'])
