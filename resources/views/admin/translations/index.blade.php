        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col d-flex justify-content-end p-1">
                        <a href="{{ url('/admin/transitionkey/create') }}" class="btn btn-success" title="افزودن یک دسته جدید">
            ...
            <div class="card-footer ltr">
                <div class="pagination-wrapper">
                    {!! $transitionkey->appends(['search' => Request::get('search')])->render() !!}
                </div>
            </div>
        </div>
    </section>
