...
class ContactController implements \App\Libraries\Template\TemplateControllerInterface
{
    ...
    public function store(\Illuminate\Http\Request $request)
    {
        ...
        $data = $request->validate([
            ...
            '__contact_us_phone_1' => 'required|string|max:255',
            '__contact_us_phone_2' => 'required|string|max:255',
            '__contact_us_email_1' => 'required|string|max:255',
            '__contact_us_email_2' => 'required|string|max:255',
        ...
        try {
            ...
            __add_stg('__contact_us_email_2', $data['__contact_us_email_2'], 'string', 'home');
